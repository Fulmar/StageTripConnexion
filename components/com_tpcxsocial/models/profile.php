 ...
 * @since		1.6
 */
class TpcxsocialModelProfile extends JModelForm
{
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_tpcxsocial.profile', 'profile', array('control' => 'jform', 'load_data' => $loadData));
        if (empty($form)) {
            return false;
        }
    ...
    protected function populateState()
    {
        ...
        $params = JFactory::getApplication()->getParams('com_tpcxsocial');
    ...
    public function save($data)
    {
        ...
        // Store the data.
        $stored = $table->getDbo()->updateObject($table->getTableName(), $table, $table->getKeyName(), false);
        if (!$stored) {
