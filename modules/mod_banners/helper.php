...
public static function getList(&$params, $tag)
    {
        ...
        $query->select('t.title, t.path');
        $query->from('#__menu as t');
		$query->where('parent_id = '.$tag.'');
    ...
    public function getUrlBanners(&$params)
    {
        // app
        $app    = JFactory::getApplication();
        $menu   = $app->getMenu();
        $item   = $menu->getItem($params->get('bannerslink'));
