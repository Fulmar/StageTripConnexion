...
<div id="slideshow" <?php echo ($active == $menu->getDefault() ? '' : 'style="display: none;"'); ?>>
    ...
    <div class="arguments">
        <span class="text"><?php echo $params->get('argument1'); ?></span>
        <span class="text"><?php echo $params->get('argument2'); ?></span>
        <span class="text"><?php echo $params->get('argument3'); ?></span>
        <div class="form">
            <p><?php echo $params->get('textbtn'); ?></p>
            <!--<select name="pays-slideshow" class="customSelectAnnuaire" onchange="$('.label-choix-pays-1').html(this.options[this.selectedIndex].innerHTML);">
