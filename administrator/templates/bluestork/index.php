...
<body id="minwidth-body">
	<div id="border-top" class="h_blue">
		<span class="logo"><img src="templates/<?php echo  $this->template ?>/images/France-tripconnexion.jpg" alt="Francais"></span>
		<span class="title"><a href="index.php">SITE FRANCAIS<?php //echo $this->params->get('showSiteName') ? $app->getCfg('sitename'). " " . JText::_('JADMINISTRATION') : JText::_('JADMINISTRATION') ; ?></a></span>
	</div>
	<div id="header-box">
		<div id="module-menu">
