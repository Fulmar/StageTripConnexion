 ...
 * Tpcxtags Model
 */
class TpcxtagsModelNewsletter extends JModelList
{
    ...
    protected function populateState($ordering = null, $direction = null)
    {
        ...
        $provenance = $this->getUserStateFromRequest($this->context.'.filter.provenance', 'filter_provenance', '', 'string');
        $this->setState('filter.provenance', $provenance);
    ...
    protected function getListQuery()
    {
        ...
        $provenance = $this->getState('filter.provenance');
        if (!empty($provenance)) {
            $query->where('(provenance = "' . $provenance . '" )');
        }
