...
$session->set("captcha_verification", md5(strtolower($rand)), md5('chrono'));
...
if(JRequest::getVar('imtype') == '1'){
	$font = dirname(__FILE__).'/components/com_chronoforms/default.ttf';
	...
	$image = imagecreatefrompng(dirname(__FILE__).'/components/com_chronoforms/background.png');
